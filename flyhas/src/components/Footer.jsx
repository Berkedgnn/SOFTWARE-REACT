          ...
          <Grid item xs={12} md={9} container spacing={2}>
            <Grid item xs={6} md={4}>
              ...
              <Box sx={{ marginTop: "8px" }}>
                <Link href="#" color="inherit" display="block" sx={{ fontStyle: "normal", textDecoration: "none" }}>About Us</Link>
                <Link href="#" color="inherit" display="block" sx={{ fontStyle: "normal", textDecoration: "none" }}>Vision & Mission</Link>
                <Link href="#" color="inherit" display="block" sx={{ fontStyle: "normal", textDecoration: "none" }}>Our Policies</Link>
                <Link href="#" color="inherit" display="block" sx={{ fontStyle: "normal", textDecoration: "none" }}>Services</Link>
              </Box>
            </Grid>
            <Grid item xs={6} md={4}>
              <Typography variant="h6" sx={{ color: "#A6CE39", fontStyle: "normal" }}>Media</Typography>
              <Box sx={{ marginTop: "8px" }}>
                <Link href="#" color="inherit" display="block" sx={{ fontStyle: "normal", textDecoration: "none" }}>Gallery</Link>
                <Link href="#" color="inherit" display="block" sx={{ fontStyle: "normal", textDecoration: "none" }}>City Guide</Link>
              </Box>
            </Grid>
            <Grid item xs={6} md={4}>
              <Typography variant="h6" sx={{ color: "#A6CE39", fontStyle: "normal" }}>Contact</Typography>
              <Box sx={{ marginTop: "8px" }}>
                <Link href="#" color="inherit" display="block" sx={{ fontStyle: "normal", textDecoration: "none" }}>Baggage Tracking</Link>
              </Box>
            </Grid>
          </Grid>
        </Grid>
