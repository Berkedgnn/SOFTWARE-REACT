...
const SeatSelectionPage = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:5000/api/seats/booked")
            .then((res) => res.json())
            .then((data) => {
                setBookedSeats(data);
            })
    ...
    const confirmSelection = () => {
        fetch("http://localhost:5000/api/seats/book", {
            ...
            .catch((err) => console.error("Error booking seats:", err));
    };
    ...
    return (
        <Box sx={{
            backgroundSize: "cover", backgroundPosition: "center", minHeight: "100vh", padding: 0,
            ...
            <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1, mt: 4 }}>
                <Grid container spacing={4}>
                    <Grid item xs={8}>
                        <Box sx={{
                            backgroundColor: "white", borderRadius: 4, borderColor: "gray", padding: 3,
                                ...
                                {rowLabels.map((rowLabel, row) => (
                                    <Grid container item key={row} spacing={3} justifyContent="center" alignItems="center">
                                        ...
                                        {[...Array(cols)].map((_, col) => {
                                            ...
                                            const seatImage = isBooked ? seat3 : isSelected ? seat2 : seat1;
                                            ...
                                            return (
                                                <Grid item key={seatLabel}>
                                                    <Button
                                                        ...
                                                        disabled={isBooked}
                                                        sx={{
                                                            minWidth: 50, minHeight: 50, padding: 0, background: "transparent",
                    ...
                    <Grid item xs={4}>
                        <Box sx={{
                            ...
                            <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                                <Box component="img" src="https://cdn-icons-png.flaticon.com/512/9187/9187604.png" alt="User Icon"
                                    sx={{ height: 40, width: 40, mr: 2 }} />
                                <Box>
                                    <Typography variant="h4" sx={{ fontWeight: "bold" }}>IGGY POP</Typography>
                                    <Typography variant="body1" sx={{ mt: 1 }}>Istanbul - London LHR</Typography>
                                    <Typography variant="body1" sx={{ mt: 1 }}>📅 25th April 2025</Typography>
                                </Box>
                            </Box>

                            <Typography variant="h6" sx={{ mb: 2 }}>Flight Cost: £65</Typography>
            ...
            <Box sx={{
                ...
                backgroundColor: "white", borderRadius: 2, padding: 2, zIndex: 2, boxShadow: 3,
            }}>
