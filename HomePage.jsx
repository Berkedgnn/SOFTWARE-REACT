          ...
          <Grid container spacing={2} justifyContent="center">
            ...
            <Grid item xs={6}>
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker label="Departure Date" value={departureDate} onChange={setDepartureDate} format="DD/MM/YYYY" renderInput={(params) => <TextField {...params} fullWidth />} />
              </LocalizationProvider>
            </Grid>
            <Grid item xs={6}>
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker label="Retun Date" value={returnDate} onChange={setReturnDate}  disabled={tripType === "oneway"} format="DD/MM/YYYY" renderInput={(params) => <TextField {...params} fullWidth />} />
              </LocalizationProvider>
            </Grid>
            <Grid item xs={12}>
            <TextField
         ...
         <Box className="bg-white rounded-2xl shadow-md p-6 max-w-5xl mx-auto mb-12">  
          ...
          <Typography 
           ...
           >
            ...
            You can get more detailed information by clicking on our{" "}
            <span 
